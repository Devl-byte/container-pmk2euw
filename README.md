...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pmk2euw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pmk2euw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Devl-byte/container-pmk2euw.git
cd container-pmk2euw
```
...
```
docker attach container-pmk2euw
```
